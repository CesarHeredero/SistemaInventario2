    ...
    public class InventarioController : Controller
    {
        ...
        public IActionResult NuevoInventario(int? inventarioId)
        {
            ...
            if (inventarioId != null)
            {
                ...
                inventarioVM.InventarioDetalles = _db.InventarioDetalle.
        ...
        [HttpPost]
        public IActionResult AgreagarProductoPost(int producto, int cantidad, int inventarioId)
        {
        ...
        public IActionResult GenerarStock(int Id)
        {
            ...
            foreach(var item in detalleLista)
            {
                var bodegaProducto = _db.BodegaProducto.Include(p => p.Producto).
                    FirstOrDefault(b => b.ProductoId == item.ProductoId && b.BodegaId == inventario.BodegaId);
